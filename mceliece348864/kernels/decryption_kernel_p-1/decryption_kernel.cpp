...
void post_fft_scaling(hls::stream<mat_struct> &out_struct,  hls::stream<vec> &inv_stream, hls::stream<vec> &eval_stream, hls::stream<vec> &recv)
{
	int i, j;
...
static void scaling_stream(hls::stream<mat_struct> &recv_stream_out, hls::stream<vec> &inv_stream, hls::stream<sk_1k_vec> &sk_irr_vec_stream, hls::stream<vec> &recv)
{
...
//	broadcast(scaled_struct_stream_0, int_mat_0_stream);
	...
	post_fft_scaling(recv_stream_out, inv_stream, eval_in_stream, recv);
}
