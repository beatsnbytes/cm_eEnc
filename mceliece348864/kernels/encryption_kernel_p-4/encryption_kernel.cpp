...
//    unsigned char e_2_mat[SYS_N/8 - SYND_BYTES];
	...
	#pragma HLS ARRAY_PARTITION variable=e_2_mat cyclic factor=109
...
{
	#pragma HLS INTERFACE m_axi     port=s_1     offset=slave depth=24  bundle=gmem
	#pragma HLS INTERFACE m_axi     port=s_2     offset=slave depth=24  bundle=gmem1
	#pragma HLS INTERFACE m_axi     port=s_3     offset=slave depth=24  bundle=gmem2
	#pragma HLS INTERFACE m_axi     port=s_4     offset=slave depth=24  bundle=gmem3
	#pragma HLS INTERFACE m_axi     port=e       offset=slave depth=436 bundle=gmem4
    	#pragma HLS INTERFACE m_axi     port=pk_1    offset=slave depth=510 bundle=gmem5
	#pragma HLS INTERFACE m_axi     port=pk_2    offset=slave depth=510 bundle=gmem6
	#pragma HLS INTERFACE m_axi     port=pk_3    offset=slave depth=510 bundle=gmem7
	#pragma HLS INTERFACE m_axi     port=pk_4    offset=slave depth=510 bundle=gmem8
    	#pragma HLS INTERFACE m_axi     port=v       offset=slave depth=1 bundle=gmem9
	#pragma HLS INTERFACE m_axi     port=key     offset=slave depth=1 bundle=gmem10
