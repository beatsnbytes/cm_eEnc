...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+44))/(ALIGNED_BYTES*2)));
    aligned_width *pk_reference_input_2 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+44))/(ALIGNED_BYTES*2)));
...
for(iter=0; iter<3; iter++){
    ...
    for(i=0; i<((PK_NROWS*(PK_ROW_BYTES+44))/(ALIGNED_BYTES*2)); i++){
