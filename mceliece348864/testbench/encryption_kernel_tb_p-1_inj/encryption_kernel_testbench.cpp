...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+44))/(ALIGNED_BYTES)));
    ...
    unsigned char *s_kernel_output_1 = (unsigned char *) malloc(sizeof(unsigned char)*(SYND_BYTES));
...
for(iter=0; iter<3; iter++){
    ...
    *key_reference_input=0;
    ...
    encryption_kernel(s_kernel_output_1, e_kernel_output, pk_reference_input_1, v_reference_input, key_reference_input);
    ...
    }/home/vitis_wksp_212/decryption_cme/src/mceliece460896/testbench/io_values/enc_1/
