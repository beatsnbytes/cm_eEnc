...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*4)));
    aligned_width *pk_reference_input_2 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*4)));
    aligned_width *pk_reference_input_3 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*4)));
    aligned_width *pk_reference_input_4 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*4)));
...
//		printf("key = %d\n", key.to_uint());
    ...
    encryption_kernel(s_kernel_output_1, s_kernel_output_2, s_kernel_output_3, s_kernel_output_4, e_kernel_output, pk_reference_input_1, pk_reference_input_2, pk_reference_input_3, pk_reference_input_4, v_reference_input, key_reference_input);
