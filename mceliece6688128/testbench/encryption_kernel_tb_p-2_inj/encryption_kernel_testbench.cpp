...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*2)));
    aligned_width *pk_reference_input_2 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+12))/(ALIGNED_BYTES*2)));
...
//		printf("key = %d\n", key.to_uint());
    ...
    encryption_kernel_active(s_kernel_output_1, s_kernel_output_2, e_kernel_output, pk_reference_input_1, pk_reference_input_2, v_reference_input, key_reference_input);
