...
#define ALIGNED_VALUES 157
#define BIT_WIDTH 1256// 157 1B values
#define ALIGNED_WIDTH 2048
...
void encryption_kernel(unsigned char *s_1, unsigned char *e, aligned_width *pk_1, v_vector *v, key_vector *key)
{
    ...
    #pragma HLS INTERFACE m_axi     port=pk_1    offset=slave depth=4082 bundle=gmem3 //TODO fix the depth here
