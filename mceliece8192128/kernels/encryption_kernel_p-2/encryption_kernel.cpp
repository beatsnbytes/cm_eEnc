...
{
	#pragma HLS INTERFACE m_axi     port=s_1     offset=slave depth=104  bundle=gmem
	#pragma HLS INTERFACE m_axi     port=s_2     offset=slave depth=104  bundle=gmem1
	#pragma HLS INTERFACE m_axi     port=e       offset=slave depth=1024  bundle=gmem2
    #pragma HLS INTERFACE m_axi     port=pk_1    offset=slave depth=5304 bundle=gmem3
	#pragma HLS INTERFACE m_axi     port=pk_2    offset=slave depth=5304 bundle=gmem4
