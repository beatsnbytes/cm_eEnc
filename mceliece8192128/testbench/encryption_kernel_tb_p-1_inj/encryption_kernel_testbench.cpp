...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*(PK_ROW_BYTES+80))/(ALIGNED_BYTES)));
...
for(iter=0; iter<4; iter++){
    ...
    for(i=0; i<((PK_NROWS*(PK_ROW_BYTES+80))/(ALIGNED_BYTES)); i++){
