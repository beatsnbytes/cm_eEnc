...
int main () { 
    ...
    //Inputs
    aligned_width *pk_reference_input_1 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*PK_ROW_BYTES)/(ALIGNED_BYTES*3)));
    aligned_width *pk_reference_input_2 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*PK_ROW_BYTES)/(ALIGNED_BYTES*3)));
    aligned_width *pk_reference_input_3 = (aligned_width *) malloc(sizeof(aligned_width)*((PK_NROWS*PK_ROW_BYTES)/(ALIGNED_BYTES*3)));
...
//		printf("key = %d\n", key.to_uint());
    ...
    encryption_kernel(s_kernel_output_1, s_kernel_output_2, s_kernel_output_3, e_kernel_output, pk_reference_input_1, pk_reference_input_2, pk_reference_input_3, v_reference_input, key_reference_input);
