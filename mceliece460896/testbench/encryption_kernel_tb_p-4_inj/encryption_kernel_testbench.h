...
void encryption_kernel_active(unsigned char *s_1, unsigned char *s_2, unsigned char *s_3, unsigned char *s_4, unsigned char *e, aligned_width *pk_1, aligned_width *pk_2, aligned_width *pk_3, aligned_width *pk_4, ap_uint<128> *v, ap_uint<256> *key);
