...
void randombytes(hls::stream<cipher_vector> &output_ciphertext_stream,  v_vector *v_local_vector_out, key_vector *key_local_vector_out, v_vector v_local_vector_in, key_vector key_local_vector_in)
{
	...
	#pragma HLS STREAM variable=v_stream_aes depth=24 //Contains 16 16B values that are incrementing
	...
	#pragma HLS STREAM variable=ciphertext_stream depth=24 //Contains 16 16B cipheretext values
...
void compute_indexes_mat(hls::stream<gf_value> &indexes_stream, v_vector *v, key_vector *key){
	...
	#pragma HLS STREAM variable=aes_ciphertext_stream depth=24
	static hls::stream<gf_value> gf_values_stream("gf values");
	#pragma HLS STREAM variable=gf_values_stream depth=196 //There should be in total 128 values. In case of dataflow this wont be full probably.
...
#pragma HLS ARRAY_PARTITION variable=gf_mat factor=96
...
void compute_e_streams(hls::stream<unsigned char> &e_1_internal_stream_1, hls::stream<unsigned char> &e_1_internal_stream_2, hls::stream<unsigned char> &e_1_internal_stream_3, hls::stream<unsigned char> &e_1_internal_stream_4, unsigned char *e_2_mat, hls::stream<unsigned char> &e_out_internal_stream, hls::stream<gf_value> &indexes_stream){
	...
	#pragma HLS PIPELINE
		...
		}else if((i>=SYND_BYTES/4) && (i<SYND_BYTES/2)){
...
static void gen_e(hls::stream<unsigned char> &e_1_stream_1, hls::stream<unsigned char> &e_1_stream_2, hls::stream<unsigned char> &e_1_stream_3, hls::stream<unsigned char> &e_1_stream_4, hls::stream<custom_width> &e_2_stream_1, hls::stream<custom_width> &e_2_stream_2, hls::stream<custom_width> &e_2_stream_3, hls::stream<custom_width> &e_2_stream_4, hls::stream<unsigned char> &e_out_stream,  v_vector *v, key_vector *key)
{
	...
	#pragma HLS STREAM variable=e_1_internal_stream_1 depth=208
    static hls::stream<unsigned char> e_1_internal_stream_2("e_1_internal stream_2");
	#pragma HLS STREAM variable=e_1_internal_stream_2 depth=208
    static hls::stream<unsigned char> e_1_internal_stream_3("e_1_internal stream_3");
	#pragma HLS STREAM variable=e_1_internal_stream_3 depth=208
    static hls::stream<unsigned char> e_1_internal_stream_4("e_1_internal stream_4");
	#pragma HLS STREAM variable=e_1_internal_stream_4 depth=208
...
void axi_aligned_pk_reader(hls::stream<aligned_width> &pk_aligned_stream, aligned_width *pk){
	...
	LOOP_LOAD_PK:
	for(i=0; i<((PK_NROWS*(PK_ROW_BYTES+92))/(ALIGNED_BYTES*4)); i++){
		#pragma HLS PIPELINE II=1
...
//TODO try with 64 bits and see how to keep the same hls optimizations
	...
	#pragma HLS PIPELINE II=1
		...
		b ^= pk_tmp.range(287, 0) & e_tmp.range(287, 0);
...
{
	#pragma HLS INTERFACE m_axi     port=s_1     offset=slave depth=39  bundle=gmem
	#pragma HLS INTERFACE m_axi     port=s_2     offset=slave depth=39  bundle=gmem1
	#pragma HLS INTERFACE m_axi     port=s_3     offset=slave depth=39  bundle=gmem2
	#pragma HLS INTERFACE m_axi     port=s_4     offset=slave depth=39  bundle=gmem3
	#pragma HLS INTERFACE m_axi     port=e       offset=slave depth=576  bundle=gmem4
    #pragma HLS INTERFACE m_axi     port=pk_1    offset=slave depth=1248 bundle=gmem1
	#pragma HLS INTERFACE m_axi     port=pk_2    offset=slave depth=1248 bundle=gmem2
	#pragma HLS INTERFACE m_axi     port=pk_3    offset=slave depth=1248 bundle=gmem3
	#pragma HLS INTERFACE m_axi     port=pk_4    offset=slave depth=1248 bundle=gmem4
