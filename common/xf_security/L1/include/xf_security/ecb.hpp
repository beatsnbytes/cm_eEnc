...
void aesEcbEncrypt(
    ...
    //If the bool is true Upate the key (this should happen only on the update function). Validate!
    ...
    // set the initialization for true
...
static void aes256EcbEncrypt(
    ...
    hls::stream<ap_uint<128> >& ciphertextStrm,
	unsigned char iters) {
    internal::aesEcbEncryptCustom<256>(plaintextStrm, cipherkeyStrm, ciphertextStrm, iters);
